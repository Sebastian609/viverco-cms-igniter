    ...
    <div class="bg-white border-2 rounded-md">
        <div class="flex justify-between p-8">
            ...
            <form class="flex justify-between">
                <input type="text" class="bg-gray-100 rounded-l-md px-6 py-3 border-2 " placeholder="Buscar Por texto principal" />
                <button type="submit" class="bg-blue-600 rounded-r-md text-white h-full aspect-square">
                    <i class="fa-solid fa-magnifying-glass text-white"></i>
                </button>
            </form>

            <a href="/slider/create" class="bg-blue-600 flex items-center justify-center text-white rounded-md px-3 py-2">
                Nuevo Slider
            </a>
                ...
                <tbody id="slider-table-body" class="text-gray-600 text-sm font-light">
                    <?php foreach ($sliders as $index => $slider): ?>
                        <tr class="draggable border-b border-gray-200 odd:bg-white even:bg-gray-50 hover:bg-gray-100 transition-colors duration-150"
                            ...
                            <td class="py-3 px-6 text-left whitespace-nowrap"><i class="fa-solid fa-grip-vertical"></i></td>
